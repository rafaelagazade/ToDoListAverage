...
function App() {
  ...
  return (
    <div className="App h-screen bg-slate-950 flex justify-center items-start mobile:h-screen mobile:w-full mobile:overflow-x-hidden laptop:w-screen laptop:h-screen laptop:overflow-x-hidden ">
